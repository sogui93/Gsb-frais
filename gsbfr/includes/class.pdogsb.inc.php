...
class PdoGsb
{
    ...
    {
        $sql = 'SELECT visiteur.id AS id, visiteur.nom AS nom, '
    ...
    {
        $requetePrepare = PdoGsb::$monPdo->prepare('SELECT * FROM visiteur');
        $requetePrepare->execute();
             ...
             'UPDATE lignefraishorsforfait '
              ...
              $requetePrepare->bindParam(':libelle', $qteL, PDO::PARAM_STR);
                $requetePrepare->bindParam(':montant', $qteM, PDO::PARAM_INT);
                 $requetePrepare->bindParam(':date', $dateFr, PDO::PARAM_STR);
               $requetePrepare->bindParam(':unIdVisiteur', $idVisiteur, PDO::PARAM_STR);
                $requetePrepare->bindParam(':unMois', $mois, PDO::PARAM_STR);
                $requetePrepare->bindParam(':idFrais', $unIdFraisH, PDO::PARAM_STR);
                $requetePrepare->execute();
     ...
     /**
     * Mise à jour des  frais hors forfait dont l'id est passé en argument
     *
     * @param String $idFrais ID du frais
     *
     * @return null
    ...
    {
        return $requetePrepare = PdoGSB::$monPdo->query($sql);
    }
}
